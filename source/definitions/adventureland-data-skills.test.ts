    ...
    const G_skills: Pick<GData, "skills"> = {
        skills: {
            ...
            aether_shield: {
                ...
                explanation:
                    "Magical damage still wounds you, but restores MP from the HP lost. Replaces Mana Shield. [Toggle]",
                level: 60,
                mp: 0,
                mp_return_levels: [
                    [60, 0.5],
            ...
            arcane_needle: {
                ...
                damage_type: "magical",
                explanation:
                    "Focus your wand into a needle that deals 75% damage, pierces 500 resistance, and cannot be reflected.",
                hostile: true,
                level: 90,
                mp: 160,
                name: "Arcane Needle",
            ...
            beacon_of_resolve: {
                ...
                duration: 8000,
                explanation:
                    "Hold the line! Nearby friendly players gain 15 Fortitude and one of each Courage for 8 seconds.",
                level: 70,
                mp: 640,
            ...
            guardians_oath: {
                ...
                duration: 8000,
                explanation:
                    "Take 35% of an ally's damage for 8 seconds. The HP you lose restores MP, whatever the damage type.",
                fixed_range: true,
                level: 50,
                link_range: 360,
                mp: 320,
            ...
            paladin_aura: {
                ...
                states: {
                    ...
                    sanctuary: {
                        ...
                        values: { mp: [150, 200, 250, 300, 600, 700], resistance: [30, 40, 50, 60, 100, 110] },
                    },
                    warding: {
                    ...
                    zeal: {
                        ...
                        name: "Aura of Zeal",
                        values: { frequency: [1, 2, 2, 3, 4, 4], output: [1, 1, 2, 2, 4, 5] },
                    },
                },
                type: "skill",
            },
