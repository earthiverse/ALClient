...
test("EntitiesData type validation", async () => {
    ...
    const anniversary_visit: EntitiesData = {
        players: [
            {
                hp: 2313,
                max_hp: 2336,
                ...
                focus: null,
                s: {
                    newcomersblessing: { ms: 1799264, f: "Trivan" },
                    mluck: { ms: 1760861, f: "Rentaro" },
                    anniversary_visit: { ms: 29339, round: 993797, realm: "US I", expires: 1788834900960 },
                },
                c: {},
                q: {},
                age: 3,
                pdps: 30731.06647706698,
                id: "Trivan",
                x: -136.87436796549105,
                y: 1878.026375271319,
                moving: false,
                going_x: -136.87436796549105,
                going_y: 1878.026375271319,
                abs: false,
                move_num: 165492,
                angle: -59.268886151423786,
                cid: 16389,
                guild: "",
                skin: "mbody5f",
                cx: { head: "fmakeup03" },
                slots: {
                    ring1: { name: "ringsj", level: 1 },
                    ring2: { name: "ringsj", level: 1 },
                    earring1: null,
                    earring2: null,
                    belt: { name: "hpbelt", level: 1 },
                    mainhand: { name: "staff", level: 5, gift: 1 },
                    offhand: null,
                    helmet: { name: "wcap", level: 5, stat_type: "int" },
                    chest: { name: "wattire", level: 4, stat_type: "int" },
                    pants: { name: "wbreeches", level: 5, stat_type: "int" },
                    shoes: { name: "wshoes", level: 6, stat_type: "int" },
                    gloves: { name: "wgloves", level: 5, stat_type: "int" },
                    amulet: { name: "intamulet", level: 1 },
                    orb: null,
                    elixir: null,
                    cape: null,
                },
                ctype: "mage",
                owner: "US_8117pFO3N8PddTBCiMSQQSrkFGSNC",
            },
        ],
        monsters: [],
        type: "xy",
    ...
    expect(anniversary_visit).toBeDefined()
})
