...
export class Priest extends PingCompensatedCharacter {
    public absorbSins(target: string): Promise<void> {
        ...
        this.socket.volatile.emit("skill", { name: "absorb", id: target })
        return absorbed
    }
    ...
    public curse(target: string): Promise<void> {
        ...
        this.socket.volatile.emit("skill", { name: "curse", id: target })
        return curseStarted
    }
    ...
    public revive(target: string, essenceoflife = this.locateItem("essenceoflife")): Promise<void> {
        ...
        this.socket.volatile.emit("skill", { name: "revive", id: target, num: essenceoflife })
        return revived
    }
}
